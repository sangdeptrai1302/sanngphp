...
// Kiểm tra xem đã thêm mới danh mục Bài viết thành công hay chưa
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="slug" name="title" placeholder="VD: chủ đề bài viết của bạn">
                  </div>
                  <div class="form-group">
                    <label for="detail">Chi tiết bài viết:</label>
                    <input type="text" class="form-control" id="detail" name="detail" placeholder="VD: chủ đề bài viết của bạn">
                  </div>
                  <div class="form-group">
