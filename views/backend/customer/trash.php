  ...
  <section class="content">
    ...
    <div class="card">
      <div class="card-header">
        <form method="post" action="index.php?option=customer&cat=destroy">
          ...
          <tbody>
            <?php foreach ($list as $row) : ?>
              <tr>
                ...
                <td>
                  <a class="btn btn-sm btn-info p-3 mr-2" style="border-radius: 17%" ; href="index.php?option=customer&cat=restore&id=<?= $row['id']; ?>">
                    <i class="fa-solid fa-rotate-left"></i>
                  </a>
                  <a class="btn btn-sm btn-danger p-3 mr-2" style="border-radius: 17%" ; href="index.php?option=customer&cat=destroy&id=<?= $row['id']; ?>">
