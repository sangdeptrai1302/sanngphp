      ...
      <div class="card-body">
        <table class="table table-bordered table-hover table-striped">
          ...
          <div class="container my-5">
            <div class="row">
              <div class="col-md-5">
                <img class="img-thumbnail" src="../public/dist/images/slider/<?php echo $page['image'] ?>" alt="">
              </div>
              <div class="col-md-7">
                ...
                <a class="btn btn-sm btn-success p-3 m-2  justify-content-center" style="border-radius: 17%" ; href="index.php?option=slider&cat=edit&id=<?= $page['id']; ?>">
                  <i class="fa-solid fa-pen-to-square"></i>
                </a>
                <a class="btn btn-sm btn-danger  p-3 m-2  justify-content-center" style="border-radius: 17%" ; href="index.php?option=slider&cat=delete&id=<?= $page['id']; ?>">
