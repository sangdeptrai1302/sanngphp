    ...
    <table class="table table-bordered table-hover table-striped"> 
        ...
        <tbody> 
            ...
            <tr> 
                ...
                <td>
                              <a class="btn btn-sm btn-info p-3 mr-2" style="border-radius: 17%"; href="index.php?option=brand&cat=restore&id=<?=$row['id'];?>"> 
                              <i class="fa-solid fa-rotate-left"></i>
                              </a>
                              <a class="btn btn-sm btn-danger p-3 mr-2" style="border-radius: 17%"; href="index.php?option=brand&cat=destroy&id=<?=$row['id'];?>"> 
